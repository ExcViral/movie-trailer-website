...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    ...
    <h2>{movie_title}</h2>
    <h6 class="movie-details">{release_year} &#x2027; {movie_generes} &#x2027; {duration}</h6>
</div>
'''
...
<div class="col-md-6 col-lg-4 tvshow-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    <img src="{poster_image_url}" width="220" height="342">
    <h2>{movie_title}</h2>
    <h6 class="movie-details">{show_generes} &#x2027; {duration}</h6>
</div>
'''
...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        # Extract the Generes from the array and concatanate them
        generes = ", ".join(movie.genere)
        # Append the tile for the movie with its content filled in
        content += movie_tile_content.format(
            movie_title=movie.title,
            poster_image_url=movie.poster_image_url,
            trailer_youtube_id=trailer_youtube_id,
            movie_generes= generes,
